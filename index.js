...
async function main() {
    ...
    const dropdown = document.getElementById('NumberSequences');
    dropdown.addEventListener('change', () => {
        const location = gl.getUniformLocation(programInfo.program, 'ns');
        gl.uniform1i(location, dropdown.selectedIndex);
    });
}
